...
#: lights[0] only (same shadow math as SHADER_DIR / "PointPhong.frag"). The vertex shader is
#: unchanged from SHADER_DIR / "PointPhong.vert" -- only the
#: lighting model in the fragment shader is different.
MULTI_LIGHT_FRAG = (SHADER_DIR / "ShowcaseMultiLight.frag").read_text()
