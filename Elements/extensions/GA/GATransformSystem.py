...
class GATransformSystem(System):
    ...
    def apply2GATransform(self, gaTransform: Elements.extensions.GA.GA_Component.GATransform):
        """
        method to be subclassed for  behavioral or logic computation 
        ...
        if (isinstance(gaTransform,Elements.extensions.GA.GA_Component.GATransform)) == False:
