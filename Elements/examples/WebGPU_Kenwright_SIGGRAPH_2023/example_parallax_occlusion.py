...
class talble(Object): 
    ...
    def onInit(self):  
        ...
        self.attachedMaterial.shader.setColorTexture(value=texture)   
        ...
        model = glm.transpose(glm.mat4x4(1))
...
class talble2(Object): 
    ...
    def onInit(self):  
        ...
        # for i in range(0, self.instance_count - 1): 
        model = glm.transpose(glm.translate(glm.mat4x4(1), glm.vec3(3.0,0.0,0.0))) 
        # model = glm.scale(model, glm.vec3(10, 10, 10))  
        # model = glm.rotate(model, np.deg2rad(-90), glm.vec3(1, 0, 0)) 
        # model = glm.rotate(model, np.deg2rad(90), glm.vec3(0, 0, 1)) 
