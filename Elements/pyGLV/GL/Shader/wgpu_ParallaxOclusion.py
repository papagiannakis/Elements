...
class ParallaxOclusion(Shader):
    ...
    def setColorTexture(self, value:Texture):
        self.attachedMaterial.uniformGroups["materialGroup"].setTexture(name="colorTexture", value=value)   

    def setHeightTexture(self, value:Texture):
        self.attachedMaterial.uniformGroups["materialGroup"].setTexture(name="heightTexture", value=value)   

    def setNormalTexture(self, value:Texture):
        self.attachedMaterial.uniformGroups["materialGroup"].setTexture(name="normalTexture", value=value)  
