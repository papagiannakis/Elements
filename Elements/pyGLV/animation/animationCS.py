...
class AnimationTransform(BasicTransform):
    ...
    def drawSelfGui(self, imgui):
        imgui.text("MANOS MANOS MANOS")
  
          
if __name__ == "__main__":
    
    # from Elements.pyGLV.animation.animationCS import AnimationTransform

    a = AnimationTransform(name="NAME", type="Anim", id="1086",trs=util.identity(),next_vec=[6,4,-3], method = 'a', hey = "b" )
    # print(a.hey)
    print(a.trs)
