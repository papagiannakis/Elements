import Elements.features.SkinnedAnimation.SkinnedAnimation
from Elements.features.SkinnedAnimation.SkinnedAnimation import AnimationComponents
...
class SkinnedAnimationSystem(System):
    ...
    def apply2AnimationComponents(self, animationComponents: Elements.features.SkinnedAnimation.SkinnedAnimation.AnimationComponents):
